                ...
                {timeSlots.map((time, timeIndex) => (
                  ...
                  >
                      ...
                      <div className="absolute top-0 left-0 right-0 bg-gradient-to-br from-yellow-500/10 to-yellow-600/20 border border-yellow-500/30 backdrop-blur-md shadow-[0_0_15px_rgba(234,179,8,0.1)] hover:shadow-[0_0_20px_rgba(234,179,8,0.2)] hover:border-yellow-500/50 transition-all duration-300 rounded-xl p-3 text-xs group" style={{ height: '96px' }}>
                        ...
                        <div className="flex items-center gap-1 mb-2">
                          <div className="flex -space-x-1">
                            ...
                            <div className="w-4 h-4 rounded-full bg-blue-500 border border-[#1F2125]"></div>
                            <div className="w-4 h-4 rounded-full bg-green-500 border border-[#1F2125]"></div>
                          </div>
                          <span className="text-gray-400 text-[10px] ml-1">meet._wrc-pgg-xx</span>
                        </div>
                        <div className="flex items-center justify-between mt-auto">
                          <button className="bg-yellow-500/20 text-yellow-400 border border-yellow-500/50 text-[10px] px-2 py-0.5 rounded hover:bg-yellow-500 hover:text-black transition-colors">Join</button>
                    ...
                    {dayIndex === 0 && timeIndex === 2 && (
                      <div className="absolute top-0 left-0 right-0 bg-gradient-to-br from-blue-500/10 to-blue-600/20 border border-blue-500/30 backdrop-blur-md shadow-[0_0_15px_rgba(59,130,246,0.1)] hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] hover:border-blue-500/50 transition-all duration-300 rounded-xl p-3 text-xs group flex flex-col" style={{ height: '192px' }}>
                        ...
                        <div className="flex items-center gap-2 mt-auto">
                          ...
                          <div className="text-gray-400 text-[10px]">Monica Rose</div>
                        </div>
                    ...
                    {dayIndex === 1 && timeIndex === 0 && (
                      <div className="absolute top-0 left-0 right-0 bg-gradient-to-br from-purple-500/10 to-purple-600/20 border border-purple-500/30 backdrop-blur-md shadow-[0_0_15px_rgba(168,85,247,0.1)] hover:shadow-[0_0_20px_rgba(168,85,247,0.2)] hover:border-purple-500/50 transition-all duration-300 rounded-xl p-3 text-xs group flex flex-col" style={{ height: '288px' }}>
                        ...
                        <div className="flex -space-x-1 mb-3">
                          ...
                          <div className="w-5 h-5 rounded-full bg-blue-500 border border-[#1F2125]"></div>
                          <div className="w-5 h-5 rounded-full bg-green-500 border border-[#1F2125]"></div>
                          <div className="w-5 h-5 rounded-full bg-[#2C2E33] border border-[#1F2125] flex items-center justify-center text-[8px] text-gray-400">+2</div>
                        </div>
                    ...
                    {dayIndex === 1 && timeIndex === 3 && (
                      <div className="absolute top-0 left-0 right-0 border-2 border-dashed border-green-500/30 bg-green-500/5 rounded-xl p-2 h-24 flex items-center justify-center cursor-pointer hover:bg-green-500/10 hover:border-green-500/60 hover:shadow-[0_0_15px_rgba(34,197,94,0.1)] transition-all duration-300 group">
                        <div className="text-center">
                          <div className="flex justify-center mb-1"><Plus size={24} className="text-green-500/50 group-hover:text-green-400 group-hover:scale-110 transition-all duration-300" /></div>
                          <div className="text-green-500/50 text-xs group-hover:text-green-400 transition-colors">Add New Task</div>
                        </div>
                      </div>
                    )}
                    ...
                    {dayIndex === 3 && timeIndex === 0 && (
                      <div className="absolute top-0 left-0 right-0 bg-gradient-to-br from-pink-500/10 to-pink-600/20 border border-pink-500/30 backdrop-blur-md shadow-[0_0_15px_rgba(236,72,153,0.1)] hover:shadow-[0_0_20px_rgba(236,72,153,0.2)] hover:border-pink-500/50 transition-all duration-300 rounded-xl p-3 text-xs group flex flex-col" style={{ height: '192px' }}>
                        ...
                        <div className="text-gray-400 text-[10px] mb-3">Deadline: July, 08</div>
                        <div className="space-y-1.5 text-[10px]">
                          <div className="flex items-center gap-2 text-green-400">
                            <div className="bg-green-500/20 p-0.5 rounded-full"><Check size={8} /></div>
                            <span>Research</span>
                          </div>
                          <div className="flex items-center gap-2 text-green-400">
                            <div className="bg-green-500/20 p-0.5 rounded-full"><Check size={8} /></div>
                          ...
                          <div className="flex items-center gap-2 text-gray-500">
                            <div className="border border-gray-600 p-0.5 rounded-full w-3 h-3"></div>
                            <span>Prototype</span>
                          </div>
                          <div className="flex items-center gap-2 text-gray-500">
                            <div className="border border-gray-600 p-0.5 rounded-full w-3 h-3"></div>
