      ...
      <div className="flex items-center justify-between bg-white dark:bg-[#0F1014] rounded-2xl p-2 border border-rose-200 dark:border-gray-800 transition-colors duration-300">
        ...
        <div className="flex items-center gap-6 pl-2">
          <button className="flex items-center gap-3 px-4 py-2 rounded-xl bg-rose-100 dark:bg-[#1F2125] text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
            ...
            <span className="bg-blue-100 dark:bg-[#2C2E33] text-blue-600 dark:text-blue-400 text-xs px-2 py-0.5 rounded-full">6</span>
          </button>

          <div className="flex items-center gap-3">
            <span className="text-gray-600 dark:text-gray-500 text-sm">Color:</span>
            <div className="flex items-center gap-2">
              ...
              <button className="w-6 h-6 rounded-full border border-gray-400 dark:border-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:border-gray-600 dark:hover:border-gray-500 transition-colors">
                <Plus size={14} />
              </button>
            </div>
          </div>
